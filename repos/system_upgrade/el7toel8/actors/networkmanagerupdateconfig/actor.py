...
# On RHEL7 NetworkManager used the 'dhclient' DHCP backend by default,
# while the default is 'internal' on RHEL8. We want to keep 'dhclient'
# enabled on upgrade, unless the user explicitly chose another backend
# in the configuration. To do so, we drop a configuration snippet in
# /usr/lib.
